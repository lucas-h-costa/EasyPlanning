                    ...
                    with tab1:   
                                ...
                                with col2:
                                    if st.button("Planejar"):
                                        reg_line_spacing, cross_line_spacing, total_reg_lines, total_cross_lines =  f.line_spacing(total_area, max_length, min_length, selected_option, average_depth, reg_line_spacing, cross_line_spacing,
