...
tab1, tab2 = st.tabs(["Planejamento de Linhas", "Tempo de levantamento"])  
...
with tab1: 
    ...
    with col1:
        ...
        nav_speed = st.number_input("Velocidade de navegação (nós):", min_value=0.0, step=1.0,  #tirar
                                    help='Velocidade de navegação em nós')
        coverage_percentage = st.slider("Cobertura do levantamento (%)", min_value=0, max_value=200, value=100, #tirar
